...
const InfoSection1 = () => {
  return (
    <div className="flex flex-col md:flex-row items-end mb-12">
      <div className="md:w-1/2 mb-8 md:mb-0">
        ...
        <ul className="grid grid-cols-2 gap-6 p-6">
          <li className="mb-2">
            <FaSwatchbook className="mb-2 text-3xl" />
          ...
          <li className="mb-2">
            <FaCodeBranch className="mb-2 text-3xl" />
            <p className="font-semibold">Live Previews</p>
            <p>Support for various color formats (HEX, RGB, HSL)</p>
          </li>
          <li className="mb-2">
            <FaDownload className="mb-2 text-3xl" />
            <p className="font-semibold">Live Previews</p>
